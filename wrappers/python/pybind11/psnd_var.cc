py::class_<VARIABLE<psnd_int>>(m, "VarInt", py::dynamic_attr())  //
    .def(py::init<const std::string&, Shape*, const std::string&>())
    .def("name", &VARIABLE<psnd_int>::name)
    .def("doc", &VARIABLE<psnd_int>::doc)
    .def("shape", &VARIABLE<psnd_int>::shape);

py::class_<VARIABLE<psnd_real>>(m, "VarReal", py::dynamic_attr())  //
    .def(py::init<const std::string&, Shape*, const std::string&>())
    .def("name", &VARIABLE<psnd_real>::name)
    .def("doc", &VARIABLE<psnd_real>::doc)
    .def("shape", &VARIABLE<psnd_real>::shape);

py::class_<VARIABLE<psnd_complex>>(m, "VarComplex", py::dynamic_attr())  //
    .def(py::init<const std::string&, Shape*, const std::string&>())
    .def("name", &VARIABLE<psnd_complex>::name)
    .def("doc", &VARIABLE<psnd_complex>::doc)
    .def("shape", &VARIABLE<psnd_complex>::shape);
...
data_flowcontrol_m.attr("at_condition")     = DATA::control::at_condition;
data_flowcontrol_m.attr("dt")               = DATA::control::dt;
data_flowcontrol_m.attr("dtsize")           = DATA::control::dtsize;
data_flowcontrol_m.attr("fail_type")        = DATA::control::fail_type;
data_flowcontrol_m.attr("frez")             = DATA::control::frez;
data_flowcontrol_m.attr("isamp")            = DATA::control::isamp;
data_flowcontrol_m.attr("istep")            = DATA::control::istep;
data_flowcontrol_m.attr("last_attempt")     = DATA::control::last_attempt;
data_flowcontrol_m.attr("msize")            = DATA::control::msize;
data_flowcontrol_m.attr("nsamp")            = DATA::control::nsamp;
data_flowcontrol_m.attr("nstep")            = DATA::control::nstep;
data_flowcontrol_m.attr("sstep")            = DATA::control::sstep;
data_flowcontrol_m.attr("succ")             = DATA::control::succ;
data_flowcontrol_m.attr("t")                = DATA::control::t;
data_flowcontrol_m.attr("tsize")            = DATA::control::tsize;
