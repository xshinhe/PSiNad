...
py::module data_control_m          = data_m.def_submodule("control");
...
data_control_m.attr("at_condition")         = DATA::control::at_condition;
data_control_m.attr("dt")                   = DATA::control::dt;
data_control_m.attr("dtsize")               = DATA::control::dtsize;
data_control_m.attr("fail_type")            = DATA::control::fail_type;
data_control_m.attr("frez")                 = DATA::control::frez;
data_control_m.attr("isamp")                = DATA::control::isamp;
data_control_m.attr("istep")                = DATA::control::istep;
data_control_m.attr("last_attempt")         = DATA::control::last_attempt;
data_control_m.attr("msize")                = DATA::control::msize;
data_control_m.attr("nsamp")                = DATA::control::nsamp;
data_control_m.attr("nstep")                = DATA::control::nstep;
data_control_m.attr("sstep")                = DATA::control::sstep;
data_control_m.attr("succ")                 = DATA::control::succ;
data_control_m.attr("t")                    = DATA::control::t;
data_control_m.attr("tsize")                = DATA::control::tsize;
