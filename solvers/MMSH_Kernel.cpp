...
// CMM Solver Builder
std::shared_ptr<Kernel> MMSH_Kernel(std::shared_ptr<Kernel> kmodel) {
    bool take_ownership_false = false;

    // Root Kernel
    std::shared_ptr<Kernel> ker(new Kernel("MMSH"));
    std::shared_ptr<Kernel_Elec_MMSH> kele(new Kernel_Elec_MMSH());
