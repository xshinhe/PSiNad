...
// CMM Solver Builder
std::shared_ptr<Kernel> MMD_Kernel(std::shared_ptr<Kernel> kmodel) {
    bool take_ownership_false = false;

    // Root Kernel
    std::shared_ptr<Kernel> ker(new Kernel("MMD"));
    std::shared_ptr<Kernel_Elec_MMD> kele(new Kernel_Elec_MMD());
