...
VARIABLE<kids_bool>    NAME_WRAPPER(integrator::pf_cross, &Dimension::shape_PF, "");
...
VARIABLE<kids_bool>    NAME_WRAPPER(iter::at_samplingstep_finally, &Dimension::shape_1, "");
VARIABLE<kids_bool>    NAME_WRAPPER(iter::at_samplingstep_initially, &Dimension::shape_1, "");
...
VARIABLE<kids_bool>    NAME_WRAPPER(iter::frez, &Dimension::shape_1, "");
VARIABLE<kids_int>     NAME_WRAPPER(iter::isamp, &Dimension::shape_1, "");
VARIABLE<kids_int>     NAME_WRAPPER(iter::istep, &Dimension::shape_1, "");
VARIABLE<kids_bool>    NAME_WRAPPER(iter::last_attempt, &Dimension::shape_1, "");
...
VARIABLE<kids_bool>    NAME_WRAPPER(iter::succ, &Dimension::shape_1, "");
