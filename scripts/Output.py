...
class Output:
    """
    Object class to read/write old.xml output file
    """

    def __init__(self, filename='old.xml', parse=False):
        """
            ...
            if os.path.isfile(self.filename):
                ...
                with open(self.filename, 'rb') as f:
                    ...
                    if b'RESTART' in out_tail[1]:
                        ...
                        Log.fatalError('Old output file found in the working directory, '
    ...
    def parse_init(self):
        """
        Method needed to parse old.xml file and populate class attributes
        :return: None
        """
    ...
    def grep(grep_key, selection):
        """
        Static method to retrieve data from XML-style old.xml
    ...
    def grep_all(self, grep_key):
        """
        This method fetch all occurrences of "grep_key" in old.xml
    ...
    def write_init(self, version, geometry, charge, command, modelH_top, real_top):
        """
        Write initial data into old.xml
    ...
    def write_normal_modes(self, NM):
        """
        Dump normal modes in old.xml for frequencies calculations
...
class Step:
    """
    Class object representing a single step, used when parsing an existing old.xml
    """
    ...
    def get_attribute(self, label):
        ...
        Also compute attributes not stored in old.xml (gradient, occupation)
