...
class QMMM:
    ...
    def __init__(self, ks_config, geometry, QM_Results, MM_Results, step, prevx1=None, prevx2=None):
        ...
        # energies of triplets: it is a dictionary with {nstate: energy of the state nstate}
        self.energies_triplet = None
        # gradient of triplets: it is a dictionary with {nstate: gradient of the state nstate}
        self.gradient_triplet = None
        # NAC of triplets: it is a dictionary with {nstate: gradient of the state nstate}
        self.nac_triplet = None
        # Spin-orbit coupling: it is a dictionary
        self.soc = None
        ...
        if "H" not in geometry.calculationType:  # MM only calculation: extract MM results
            ...
            if len(QM_Results.tripletenergydict) > 0: # Find triplets
