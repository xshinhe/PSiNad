...
import qmmmenv  # general purpose functions in use in COBRAMM
...
class CobrammOutput:
    ...
    def __init__(self, out_dir, store_files=False):
        ...
        if self.xmloutput.normal_modes:
            ...
            qmmmenv.setCobrammProfile()
            # check that the environment for gaussian is actually defined
            env_defined, error_msg = qmmmenv.checkGaussianOptEnv()
            if not env_defined:
