...
@Timer("vel-verlet")
def run(cobcom, geometry, command, Tot_Grad, E_pot, step, iniD, CSA):
    ...
    # OW this two step feature is really deep in the intestines of cobram ....
    try:
        inp1 = open('TSTEP')
    ...
    # Second half step VV
    # previously skipped in step 0 from here ...
    for i in range(len(at)):
    ...
    if int(command[85]) > 3 and os.path.exists(os.getcwd() + '/HOP'):
        logwrt.writelog("\n")
        ...
        # in case of command[206] == '0', scaling is done in the direction of the NAC / gradient difference
        if command[206] == '0':
            if command[14] == '0' or command[14] == '2':
                NAC = sef['NAC']
            elif command[14] == '1':
                GD = sef['GD']
        sef.close()
        ...
        # in case of command[206] == '0', scaling is done in the direction of the NAC / gradient difference
        if command[206] == '0':
            # define the direction of the rescaling
            if command[14] == '0' or command[14] == '2':
        ...
        # in case of command[206] == '1', use another type of rescaling
        elif command[206] == '1':
