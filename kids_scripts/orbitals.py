...
class Shell:
    ...
    def __init__(self, idAtom, center, angMom, cartesian, alphaList, coeffList):
        ...
        if len(coeffList) == self.nContract:
            ...
            Log.fatalError("contraction degree mismatch in atomic orbital shell definition\n"
        ...
        try:
            ...
            Log.fatalError("Cannot construct a shell of type {}.\n".format(angMom.upper()) +
...
class Orbitals:
    ...
    def readMOfromGaussianOutput(cls, gFileName):
        ...
        if radialType == "(5D, 7F)":
            ...
            Log.fatalError("the radial definitions of basis set '{0}' is not implemented!\n".format(radialType) +
        ...
        try:
            ...
            Log.fatalError("cannot fine the basis set definition in the Gaussian log!\n" +
