...
class Kernel_Conserve final : public Kernel {
   ...
   private:
    span<psnd_real> E;          ///< adiabatic energies?
    span<psnd_real> p;          ///< nuclear momemtum
    span<psnd_real> m;          ///< nuclear mass
    span<psnd_real> Etot;       ///< total energy
    span<psnd_real> Etot_prev;  ///< total energy in previous step
    span<psnd_real> Etot_init;  ///< total energy at initial time
    span<psnd_real> Ekin;       ///< kinematic energy
    span<psnd_real> Epot;       ///< potential energy
    span<psnd_real> vpes;       ///< potential energy (only nuclear part)
