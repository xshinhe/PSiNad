...
int Kernel_Update_Coup::calc_Ekin(span<kids_real> Ekin,  // [P]
 ...
 */
int Kernel_Update_Coup::calc_Snuc(span<kids_complex> Snuc,   // [P,P]
...
int Kernel_Update_Coup::calc_Sele(span<kids_complex> Sele,   // [P,P]
...
int Kernel_Update_Coup::calc_dtlnSnuc(span<kids_complex> dtlnSnuc,  // [P,P]
...
int Kernel_Update_Coup::calc_dtSele(span<kids_complex> dtSele,  // [P,P]
...
double Kernel_Update_Coup::calc_density(span<kids_complex> rhored,   // [F,F]
...
int Kernel_Update_Coup::calc_Hbasis(span<kids_complex> Hbasis,  // [P,P]
                                        span<kids_real>    vpes,    // [P]
...
int Kernel_Update_Coup::calc_Hbasis_adia(span<kids_complex> Hbasis,  // [P,P]
...
Status& Kernel_Update_Coup::initializeKernel_impl(Status& stat) { return stat; }
...
Status& Kernel_Update_Coup::impl_0(Status& stat) {
...
Status& Kernel_Update_Coup::impl_1(Status& stat) {
...
int Kernel_Update_Coup::cloning() {
    P_used_ptr[0] = P_used;
