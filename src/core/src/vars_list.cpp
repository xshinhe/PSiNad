...
VARIABLE<kids_int>     NAME_WRAPPER(flowcontrol::scheme_id, &shape_1, "");
VARIABLE<kids_int>     NAME_WRAPPER(flowcontrol::solver_id, &shape_1, "");
VARIABLE<kids_int>     NAME_WRAPPER(flowcontrol::calc_id, &shape_1, "");
VARIABLE<kids_int>     NAME_WRAPPER(flowcontrol::step_id, &shape_1, "");
VARIABLE<kids_bint>    NAME_WRAPPER(flowcontrol::at_condition, &shape_1, "");
// VARIABLE<kids_bint>    NAME_WRAPPER(flowcontrol::at_samplingstep_finally, &shape_1, "");
// VARIABLE<kids_bint>    NAME_WRAPPER(flowcontrol::at_samplingstep_initially, &shape_1, "");
...
VARIABLE<kids_int>     NAME_WRAPPER(flowcontrol::istep, &shape_1, "");
VARIABLE<kids_bint>    NAME_WRAPPER(flowcontrol::last_attempt, &shape_1, "");
VARIABLE<kids_int>     NAME_WRAPPER(flowcontrol::msize, &shape_1, "");
VARIABLE<kids_int>     NAME_WRAPPER(flowcontrol::nsamp, &shape_1, "");
VARIABLE<kids_int>     NAME_WRAPPER(flowcontrol::nstep, &shape_1, "");
VARIABLE<kids_int>     NAME_WRAPPER(flowcontrol::sstep, &shape_1, "");
VARIABLE<kids_bint>    NAME_WRAPPER(flowcontrol::succ, &shape_1, "");
VARIABLE<kids_real>    NAME_WRAPPER(flowcontrol::t, &shape_1, "");
VARIABLE<kids_int>     NAME_WRAPPER(flowcontrol::tsize, &shape_1, "");
