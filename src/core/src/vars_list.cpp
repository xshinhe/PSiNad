...
VARIABLE<kids_real>    NAME_WRAPPER(init::Etot, &shape_P, "init total energy");
VARIABLE<kids_real>    NAME_WRAPPER(init::p, &shape_PN, "init nuclear momentum");
VARIABLE<kids_real>    NAME_WRAPPER(init::x, &shape_PN, "init nuclear coordinate");
VARIABLE<kids_real>    NAME_WRAPPER(init::T, &shape_PFF, "init ADT matrix");
VARIABLE<kids_complex> NAME_WRAPPER(init::c, &shape_PF, "init.c");
VARIABLE<kids_complex> NAME_WRAPPER(init::cset, &shape_PFF, "init.cset");
VARIABLE<kids_complex> NAME_WRAPPER(init::rho_ele, &shape_PFF, "init.rho_ele");
VARIABLE<kids_complex> NAME_WRAPPER(init::rho_nuc, &shape_PFF, "init.rho_nuc");
VARIABLE<kids_complex> NAME_WRAPPER(init::rho_dual, &shape_PFF, "init.rho_dual");

VARIABLE<kids_real> NAME_WRAPPER(parameter::xi0, &shape_1, "parameter");
VARIABLE<kids_real> NAME_WRAPPER(parameter::xi1, &shape_1, "parameter");
VARIABLE<kids_real> NAME_WRAPPER(parameter::xi2, &shape_1, "parameter");
VARIABLE<kids_real> NAME_WRAPPER(parameter::xi3, &shape_1, "parameter");
VARIABLE<kids_real> NAME_WRAPPER(parameter::xiw, &shape_1, "parameter");
VARIABLE<kids_real> NAME_WRAPPER(parameter::xir, &shape_1, "parameter");
VARIABLE<kids_real> NAME_WRAPPER(parameter::gamma0, &shape_1, "parameter");
VARIABLE<kids_real> NAME_WRAPPER(parameter::gamma1, &shape_1, "parameter");
VARIABLE<kids_real> NAME_WRAPPER(parameter::gamma2, &shape_1, "parameter");
...
VARIABLE<kids_real>    NAME_WRAPPER(integrator::GWP::L1, &shape_P, "L1");
VARIABLE<kids_real>    NAME_WRAPPER(integrator::GWP::L2, &shape_P, "L2");
VARIABLE<kids_complex> NAME_WRAPPER(integrator::GWP::R, &shape_PP, "EV used for GWP");
VARIABLE<kids_complex> NAME_WRAPPER(integrator::GWP::R1, &shape_PP, "R1");
VARIABLE<kids_complex> NAME_WRAPPER(integrator::GWP::R2, &shape_PP, "R2");
VARIABLE<kids_complex> NAME_WRAPPER(integrator::GWP::S1, &shape_PP, "overlap used for GWP");
VARIABLE<kids_complex> NAME_WRAPPER(integrator::GWP::S1h, &shape_PP, "S1h");
VARIABLE<kids_complex> NAME_WRAPPER(integrator::GWP::S2, &shape_PP, "S2");
VARIABLE<kids_complex> NAME_WRAPPER(integrator::GWP::S2h, &shape_PP, "S2h");
VARIABLE<kids_complex> NAME_WRAPPER(integrator::GWP::Sx, &shape_PP, "Sx");
VARIABLE<kids_complex> NAME_WRAPPER(integrator::GWP::invS1h, &shape_PP, "inversed overlap used for GWP");
VARIABLE<kids_complex> NAME_WRAPPER(integrator::GWP::invS2h, &shape_PP, "invS2h");
VARIABLE<kids_complex> NAME_WRAPPER(integrator::Hbasis, &shape_PP, "Hb");
VARIABLE<kids_complex> NAME_WRAPPER(integrator::Hcoeff, &shape_PP, "Hcoeff");
VARIABLE<kids_complex> NAME_WRAPPER(integrator::K0, &shape_PFF, "K0");
...
VARIABLE<kids_complex> NAME_WRAPPER(integrator::KSHA, &shape_PFF, "");
VARIABLE<kids_complex> NAME_WRAPPER(integrator::KTWA, &shape_PFF, "");
...
VARIABLE<kids_complex> NAME_WRAPPER(integrator::S, &shape_PP, "S");
VARIABLE<kids_complex> NAME_WRAPPER(integrator::Sele, &shape_PP, "Sele");
VARIABLE<kids_complex> NAME_WRAPPER(integrator::Snuc, &shape_PP, "");
VARIABLE<kids_complex> NAME_WRAPPER(integrator::U, &shape_PFF, "");
VARIABLE<kids_complex> NAME_WRAPPER(integrator::UXdt, &shape_PP, "UX");
VARIABLE<kids_complex> NAME_WRAPPER(integrator::UYdt, &shape_PP, "UY");
VARIABLE<kids_complex> NAME_WRAPPER(integrator::Ubranch, &shape_PFF, "Ub");  //? check size
VARIABLE<kids_complex> NAME_WRAPPER(integrator::Udt, &shape_PFF, "");
VARIABLE<kids_complex> NAME_WRAPPER(integrator::Ucdt, &shape_PFF, "");
...
VARIABLE<kids_complex> NAME_WRAPPER(integrator::cset, &shape_PFF, "electronic amplitude");
...
VARIABLE<kids_real>    NAME_WRAPPER(integrator::m, &shape_PN, "mass of trajectories");
VARIABLE<kids_real>    NAME_WRAPPER(integrator::minv, &shape_PN, "inversed mass of trajectories");
VARIABLE<kids_real>    NAME_WRAPPER(integrator::nhc::G, &shape_X, "G");
VARIABLE<kids_real>    NAME_WRAPPER(integrator::nhc::Q, &shape_X, "Q");
VARIABLE<kids_real>    NAME_WRAPPER(integrator::nhc::p, &shape_X, "p");
VARIABLE<kids_real>    NAME_WRAPPER(integrator::nhc::x, &shape_X, "x");
...
VARIABLE<kids_real>    NAME_WRAPPER(integrator::monodromy::mono, &shape_PN4N4, "mono");
...
VARIABLE<kids_real>    NAME_WRAPPER(integrator::COUP::gf_all, &shape_PP, "");
...
VARIABLE<kids_real>    NAME_WRAPPER(integrator::COUP::term_1, &shape_PFF, "");
...
VARIABLE<kids_real>    NAME_WRAPPER(integrator::x, &shape_PN, "coordinate of trajectories");
VARIABLE<kids_real>    NAME_WRAPPER(integrator::xgrid, &shape_Nxgrid, "");
VARIABLE<kids_int>     NAME_WRAPPER(control::scheme_id, &shape_1, "");
VARIABLE<kids_int>     NAME_WRAPPER(control::solver_id, &shape_1, "");
VARIABLE<kids_int>     NAME_WRAPPER(control::calc_id, &shape_1, "");
VARIABLE<kids_int>     NAME_WRAPPER(control::step_id, &shape_1, "");
VARIABLE<kids_bint>    NAME_WRAPPER(control::at_condition, &shape_1, "");
// VARIABLE<kids_bint>    NAME_WRAPPER(control::at_samplingstep_finally, &shape_1, "");
// VARIABLE<kids_bint>    NAME_WRAPPER(control::at_samplingstep_initially, &shape_1, "");
VARIABLE<kids_real>    NAME_WRAPPER(control::dt, &shape_1, "");
VARIABLE<kids_real>    NAME_WRAPPER(control::pertimeunit, &shape_1, "");
VARIABLE<kids_int>     NAME_WRAPPER(control::dtsize, &shape_1, "");
VARIABLE<kids_int>     NAME_WRAPPER(control::last_tried_dtsize, &shape_1, "");
VARIABLE<kids_int>     NAME_WRAPPER(control::fail_type, &shape_1, "");
VARIABLE<kids_bint>    NAME_WRAPPER(control::frez, &shape_1, "");
VARIABLE<kids_int>     NAME_WRAPPER(control::isamp, &shape_1, "");
VARIABLE<kids_int>     NAME_WRAPPER(control::istep, &shape_1, "");
VARIABLE<kids_bint>    NAME_WRAPPER(control::last_attempt, &shape_1, "");
VARIABLE<kids_int>     NAME_WRAPPER(control::msize, &shape_1, "");
VARIABLE<kids_int>     NAME_WRAPPER(control::nsamp, &shape_1, "");
VARIABLE<kids_int>     NAME_WRAPPER(control::nstep, &shape_1, "");
VARIABLE<kids_int>     NAME_WRAPPER(control::sstep, &shape_1, "");
VARIABLE<kids_bint>    NAME_WRAPPER(control::succ, &shape_1, "");
VARIABLE<kids_real>    NAME_WRAPPER(control::t, &shape_1, "");
VARIABLE<kids_int>     NAME_WRAPPER(control::tsize, &shape_1, "");
...
VARIABLE<kids_real>    NAME_WRAPPER(last::dV, &shape_PNFF, "dV");
...
VARIABLE<kids_real>    NAME_WRAPPER(model::Kmat, &shape_NN, "nuclear oscillation matrix");
...
VARIABLE<kids_complex> NAME_WRAPPER(model::MB::SYred, &shape_P, "");
VARIABLE<kids_complex> NAME_WRAPPER(model::MB::SZred, &shape_P, "");
VARIABLE<kids_complex> NAME_WRAPPER(model::MB::H1, &shape_PFF, "");
VARIABLE<kids_complex> NAME_WRAPPER(model::MB::H2, &shape_PFF, "");
VARIABLE<kids_real>    NAME_WRAPPER(model::rep::eig, &shape_PF, "eig");
VARIABLE<kids_real>    NAME_WRAPPER(model::rep::E, &shape_PFF, "");
VARIABLE<kids_complex> NAME_WRAPPER(model::rep::H, &shape_PFF, "");
VARIABLE<kids_real>    NAME_WRAPPER(model::rep::lam, &shape_PF, "");
...
VARIABLE<kids_real>    NAME_WRAPPER(model::rep::dE, &shape_PNFF, "dE");
VARIABLE<kids_real>    NAME_WRAPPER(model::rep::ddE, &shape_PNNFF, "ddE");
VARIABLE<kids_real>    NAME_WRAPPER(model::rep::nac, &shape_PNFF, "nac");
