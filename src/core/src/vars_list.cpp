...
VARIABLE<kids_complex> NAME_WRAPPER(init::rho_ele, &shape_PFF, "nuclear coordinate");
VARIABLE<kids_complex> NAME_WRAPPER(init::rho_nuc, &shape_PFF, "nuclear coordinate");
VARIABLE<kids_complex> NAME_WRAPPER(init::rho_dual, &shape_PFF, "nuclear coordinate");
...
VARIABLE<kids_real>    NAME_WRAPPER(model::rep::eig, &shape_PF, "");
