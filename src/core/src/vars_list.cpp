...
VARIABLE<kids_real>    NAME_WRAPPER(model::Kmat, &shape_FF, "nuclear oscillation matrix");
...
VARIABLE<kids_real>    NAME_WRAPPER(model::bath::p_sigma, &shape_Nb, "discretized x standord error for a bath");
VARIABLE<kids_real>    NAME_WRAPPER(model::bath::x_sigma, &shape_Nb, "discretized p standord error for a bath");
