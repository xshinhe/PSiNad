...
#ifndef PSND_VARIABLEDESCRIPTOR_H
#define PSND_VARIABLEDESCRIPTOR_H
...
struct VariableDescriptor {
   public:
     ...
     * @param DS Shared pointer to the DataSet containing the variable's data.
     */
    void defineIn(std::shared_ptr<DataSet> DS, psnd_dtype data_type = psnd_void_type,
   ...
   private:
    ...
    VariableDescriptorPolicy::_type vtype;
    ...
    psnd_dtype dataType;         /**< The data type of the variable. */
...
#endif  // PSND_VARIABLEDESCRIPTOR_H
