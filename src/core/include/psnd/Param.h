...
class Param final {
   public:
    ...
    void set_real(const std::string &key, psnd_real val);
    ...
    void set_real_ifndef(const std::string &key, psnd_real val);

    void set_string_ifndef(const std::string &key, std::string val);


    psnd_bool   get_bool(const std::vector<std::string> &keys, const std::string &loc, const psnd_bool &default_value);
    psnd_bool   get_bool(const std::vector<std::string> &keys, const std::string &loc = "__loc__");
    psnd_int    get_int(const std::vector<std::string> &keys, const std::string &loc, const psnd_int &default_value);
    psnd_int    get_int(const std::vector<std::string> &keys, const std::string &loc = "__loc__");
    ...
    psnd_real   get_real(const std::vector<std::string> &keys, const std::string &loc, const phys::dimension7 &qdim,
                         const psnd_real &default_value = psnd_real());
    psnd_real   get_real(const std::vector<std::string> &keys, const std::string &loc, const psnd_real &default_value);
    psnd_real   get_real(const std::vector<std::string> &keys, const std::string &loc = "__loc__");
