 ...
 * @details
 *  Kernal is one of the most important classes in PSND, and is responsible
...
#ifndef PSND_Kernel_H
#define PSND_Kernel_H
...
class Kernel : public std::enable_shared_from_this<Kernel> {
   public:
    ...
    /**
     * Set flags for only once call.
     */
    void setCallOnlyOnce();
