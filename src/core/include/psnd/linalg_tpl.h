...
#ifndef PSND_LINALG_TPL_H
#define PSND_LINALG_TPL_H
...
typedef EigVX<psnd_real>    EigVXr;
typedef EigVX<psnd_complex> EigVXc;
typedef EigMX<psnd_real>    EigMXr;
typedef EigMX<psnd_complex> EigMXc;
typedef EigMX<psnd_real>    EigAXr;
typedef EigMX<psnd_complex> EigAXc;
...
inline void LinearSolve(psnd_real* x, psnd_real* A, psnd_real* b, size_t N) {
    MapMXr Mapx(x, N, 1);
    MapMXr MapA(A, N, N);
    MapMXr Mapb(b, N, 1);
...
inline void EigenSolve(psnd_real* E, psnd_real* T, psnd_real* A, size_t N) {
    MapMXr                                MapE(E, N, 1);
    MapMXr                                MapT(T, N, N);
    MapMXr                                MapA(A, N, N);
...
inline void EigenSolve(psnd_real* E, psnd_complex* T, psnd_complex* A, size_t N) {
    MapMXr                                MapE(E, N, 1);
    MapMXc                                MapT(T, N, N);
    MapMXc                                MapA(A, N, N);
...
inline void EigenSolve(psnd_complex* E, psnd_complex* T, psnd_complex* A, size_t N) {
    MapMXc                            MapE(E, N, 1);
    MapMXc                            MapT(T, N, N);
    MapMXc                            MapA(A, N, N);
...
inline void PseudoInverse(psnd_real* A, psnd_real* invA, size_t N, psnd_real e = 1E-5) {
    MapMXr MapA(A, N, N);
