...
#include "psnd/utils/span.hpp"  // from https://github.com/tcbrindle/span
template <typename T>
...
class DataSet final : public Node {
   ...
   public:
    ...
    span<psnd_int>     def(const VARIABLE<psnd_int>& var, const span<psnd_int>& arr_in = span<psnd_int>());
    span<psnd_real>    def(const VARIABLE<psnd_real>& var, const span<psnd_real>& arr_in = span<psnd_real>());
    span<psnd_complex> def(const VARIABLE<psnd_complex>& var, const span<psnd_complex>& arr_in = span<psnd_complex>());
    span<psnd_int>     def(const VARIABLE<psnd_int>& var, const std::string& ds_file);
    span<psnd_real>    def(const VARIABLE<psnd_real>& var, const std::string& ds_file);
    span<psnd_complex> def(const VARIABLE<psnd_complex>& var, const std::string& ds_file);
    span<psnd_int>     def(const VARIABLE<psnd_int>& var, std::shared_ptr<DataSet> ds_ptr);
    span<psnd_real>    def(const VARIABLE<psnd_real>& var, std::shared_ptr<DataSet> ds_ptr);
    span<psnd_complex> def(const VARIABLE<psnd_complex>& var, std::shared_ptr<DataSet> ds_ptr);
     ...
     */
    psnd_int* def_int(const std::string& key, Shape S = 1, const std::string& info = "");
     ...
     * @return Pointer to the defined variable.
     */
    psnd_int* def_int(const std::string& key, psnd_int* arr_in, Shape S = 1, const std::string& info = "");
     ...
     * @return Pointer to the defined variable.
     */
    psnd_int* def_int(const std::string& key, const std::string& key_in, const std::string& info = "");
     ...
     * @return Pointer to the defined variable.
     */
    psnd_real* def_real(const std::string& key, Shape S = 1, const std::string& info = "");
    psnd_real* def_real_replace(const std::string& key, Shape S = 1, const std::string& info = "");
     ...
     * @return Pointer to the defined variable.
     */
    psnd_real* def_real(const std::string& key, psnd_real* arr_in, Shape S = 1, const std::string& info = "");
     ...
     * @return Pointer to the defined variable.
     */
    psnd_real* def_real(const std::string& key, const std::string& key_in, const std::string& info = "");
     ...
     * @return Pointer to the defined variable.
     */
    psnd_complex* def_complex(const std::string& key, Shape S = 1, const std::string& info = "");
    psnd_complex* def_complex_replace(const std::string& key, Shape S = 1, const std::string& info = "");
     ...
     * @return Pointer to the defined variable.
     */
    psnd_complex* def_complex(const std::string& key, psnd_complex* arr_in, Shape S = 1, const std::string& info = "");
     ...
     * @return Pointer to the defined variable.
     */
    psnd_complex* def_complex(const std::string& key, const std::string& key_in, const std::string& info = "");
     ...
     */
    std::tuple<psnd_dtype, void*, Shape*> obtain(const std::string& key);
   ...
   private:
     ...
     * Define a variable of type psnd_int.
     * @param var The variable to define.
     * @return Pointer to the defined variable.
     */
    psnd_int* def_get_pointer(VARIABLE<psnd_int>& var);

    /**
     * @deprecated please use span for pass the data
     * Define a variable of type psnd_real.
     * @param var The variable to define.
     * @return Pointer to the defined variable.
     */
    psnd_real* def_get_pointer(VARIABLE<psnd_real>& var);

    /**
     * @deprecated please use span for pass the data
     * Define a variable of type psnd_complex.
     * @param var The variable to define.
     * @return Pointer to the defined variable.
     */
    psnd_complex* def_get_pointer(VARIABLE<psnd_complex>& var);
