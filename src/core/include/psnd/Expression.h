...
#ifndef PSND_EXPRESSION_H
#define PSND_EXPRESSION_H

#include <string>
#include <vector>

#ifdef PSND_EXPRESSION_USE_EXPRTK
#include "exprtk/exprtk.hpp"               ///< @ref https://www.partow.net/programming/exprtk
#elif defined(PSND_EXPRESSION_USE_LEPTON)  // LEPTON is a math parser by OPENMM-team
#else                                      // by default using fparser.h
#include "fparser/fparser.hh"              ///< @ref http://warp.povusers.org/FunctionParser/fparser.html
#endif                                     // PSND_EXPRESSION_USE_EXPRTK
